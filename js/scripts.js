...
function doMath()
{
	...
	if (action == "add" || action == "addition") {
		const number1 = parseInt(prompt("What number would you like to start with?"));
		const number2 = parseInt(prompt("What number are you adding to " + number1 + "?"));
		...
		const number1 = parseInt(prompt("What number would you like to start with?"));
		const number2 = parseInt(prompt("What number are you subtracting " + number1 + " from?"));
		...
		const number1 = parseInt(prompt("What number would you like to start with?"));
		const number2 = parseInt(prompt("What number are you multipliying " + number1 + " with?"));
		...
		const number1 = parseInt(prompt("What number would you like to start with?"));
		const number2 = parseInt(prompt("What number are you dividing " + number1 + " with?"));
		...
		const number1 = parseInt(prompt("What number would you like to start with?"));
		const number2 = parseInt(prompt("What number are you dividing " + number1 + " with to get the remainder?"));
